...
export const products = [
  ...
  {
    id: 1,
    name: "MSQ 01 матрас, обивка текстиль, 90x80x280 см, серый, бежевый",
    price: 105069,
    ...
    image: "https://resources.cdn-kaspi.kz/medias/sys_master/images/images/h8c/h4e/62698857103390/matras-v-dom-i-sad-002-80x200x10-sm-chekhol-tik-106577484-1.jpg",
    rating: 4,
    category: "Furniture",
    visible: true,
    likes: false,
